...
> this section also explains `.client_java` files since the both have the same structure where the difference comes in the code generated by vangav backend
