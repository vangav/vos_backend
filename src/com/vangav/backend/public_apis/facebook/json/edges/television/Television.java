 ...
 */
/**
 * Television represents Facebook's graph API edge television
 * 
 * Reference:
 * https://developers.facebook.com/docs/graph-api/reference/v2.7/user
 * */
@JsonIgnoreProperties(ignoreUnknown = true)
public class Television extends FacebookGraphApiEdge {
  ...
  @Override
  @JsonIgnore
  protected Television getThis () throws Exception {
