 ...
 */
/**
 * AgeRange represents Facebook's graph API age_range field
 * 
 * Reference:
 * https://developers.facebook.com/docs/graph-api/reference/v2.7/user
 * */
@JsonIgnoreProperties(ignoreUnknown = true)
public class AgeRange extends FacebookGraphApiField {
  ...
  @Override
  @JsonIgnore
  protected AgeRange getThis () throws Exception {
  ...
  @JsonProperty
  public AgeRangeElement age_range;
