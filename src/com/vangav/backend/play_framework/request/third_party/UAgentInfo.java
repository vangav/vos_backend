package com.vangav.backend.play_framework.request.third_party;
...
public class UAgentInfo {
  ...
  public boolean             isWebkit              = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectWebkit()
  public boolean             isMobilePhone         = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectMobileQuick()
  public boolean             isIphone              = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectIphone()
  public boolean             isAndroid             = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectAndroid()
  public boolean             isAndroidPhone        = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectAndroidPhone()
  public boolean             isTierTablet          = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectTierTablet()
  public boolean             isTierIphone          = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectTierIphone()
  public boolean             isTierRichCss         = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
                                                                           // DetectTierRichCss()
  public boolean             isTierGenericMobile   = false;               // Stores
                                                                           // the
                                                                           // result
                                                                           // of
  ...
  public static final String deviceHtcFlyer        = "htc_flyer";         // HTC
                                                                           // Flyer
  ...
  public static final String deviceBB10            = "bb10";              // For
                                                                           // the
                                                                           // new
                                                                           // BB
                                                                           // 10
  ...
  public static final String deviceBBBold          = "blackberry97";      // Bold
                                                                           // 97x0
                                                                           // (non-touch)
  public static final String deviceBBBoldTouch     = "blackberry 99";     // Bold
                                                                           // 99x0
                                                                           // (touchscreen)
  ...
  public static final String deviceWebOS           = "webos";             // For
                                                                           ...
                                                                           // WebOS
                                                                           // devices
  public static final String deviceWebOShp         = "hpwos";             // For
                                                                           // HP's
                                                                           // line
                                                                           // of
                                                                           // WebOS
  ...
  public static final String deviceNuvifone        = "nuvifone";          // Garmin
                                                                           // Nuvifone
  public static final String deviceBada            = "bada";              // Samsung's
                                                                           // Bada
                                                                           // OS
  public static final String deviceTizen           = "tizen";             // Tizen
                                                                           // OS
  public static final String deviceMeego           = "meego";             // Meego
                                                                           // OS
  ...
  public static final String deviceTablet          = "tablet";            // Generic
                                                                           // term
                                                                           // for
                                                                           // slate
                                                                           // and
  ...
  public static final String engineTelecaQ         = "teleca q";          // a
                                                                           ...
                                                                           // phone
                                                                           // browser
  public static final String engineObigo           = "obigo";             // W
                                                                           // 10
                                                                           // is
                                                                           // a
                                                                           // modern
  ...
  public boolean detectAndroidPhone() {
    ...
    if (detectAndroid() && (userAgent.indexOf(mobile) != -1))
      return true;
    // Special check for Android phones with Opera Mobile. They should report
    // here.
  ...
  public boolean detectMaemoTablet() {
    if (userAgent.indexOf(maemo) != -1) {
      return true;
        ...
        && userAgent.indexOf(deviceTablet) != -1 && !detectWebOSTablet()
        && !detectAndroid()) {
      return true;
    }
    return false;
