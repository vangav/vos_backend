...
+ shows how to add controllers (api entry points) before and after service generation | on [YouTube](https://www.youtube.com/watch?v=1ObkXurqNs0&index=3&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv)

### 2. [project's contents](https://github.com/vangav/vos_backend/blob/master/README/01_project_contents.md)

+ explains the building blocks of vangav backend | on [YouTube](https://www.youtube.com/watch?v=gDrcH1bopfU&index=4&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv&t=87)
...
+ generates a service that has a backend database and also uses the geo services utility | on [YouTube](https://www.youtube.com/watch?v=gDrcH1bopfU&index=4&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv&t=406)
...
+ explains the building blocks of a generated service | on [YouTube](https://www.youtube.com/watch?v=gDrcH1bopfU&index=4&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv&t=638)
...
+ explains the building blocks of the config used to generate a service | on [YouTube](https://www.youtube.com/watch?v=gDrcH1bopfU&index=4&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv&t=491)

### 6. [request object](https://github.com/vangav/vos_backend/blob/master/README/05_request_structure.md)

+ when implementing a service's logic, the passed request object keeps all the request's information from start to finish; this tutorial shows how to use that object | on [YouTube](https://www.youtube.com/watch?v=BZhmi7MCG6g&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv&index=7&t=325)

### 7. [error response](https://github.com/vangav/vos_backend/blob/master/README/06_error_response.md)

+ explains what happens whenever an error happens during request processing and how to manually return various types of error response | on [YouTube](https://www.youtube.com/watch?v=v3PxKDMehvY&index=2&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv&t=283)

### 8. [using dispatcher - worker(s)](https://github.com/vangav/vos_backend/blob/master/README/07_dispatcher_worker.md)

+ shows why and how to us the dispatcher with one or more worker service(s) | on [YouTube](https://www.youtube.com/watch?v=BZhmi7MCG6g&list=PLTcKayTjao6rOj02gtRdiVhvzB1SWGyhv&index=7&t=663)
